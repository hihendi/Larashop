                     ...
                     @can('admin-access')
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                <a class="dropdown-item" href="{{ route('categories.index') }}"><i class="fa fa-tasks"></i> Categories</a>
                                <a class="dropdown-item" href="{{ route('products.index') }}"><i class="fa fa-shopping-bag"></i> Products</a>
                                <a class="dropdown-item" href="#">Users</a>
                            </div>
                        </li>
                                @elsecan('staff-access')
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Manage</a>
                            <div class="dropdown-menu" aria-labelledby="navbarDropdown">
